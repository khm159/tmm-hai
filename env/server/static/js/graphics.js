...
class OvercookedScene extends Phaser.Scene {
    ...
    _drawState (state, sprites) {
        ...
        sprites["indicators"] = typeof(sprites['indicators']) === 'undefined' ? {} : sprites['indicators'];
        if (visibilityDots) {
    ...
    _drawInstructions(sprites, board_height, width) {
        if (typeof(sprites['instructions']) == 'undefined') {
            sprites['instructions'] = this.add.text(
                150, board_height + 30, "You are the GREEN chef! You can only see the GREEN dotted region.\nCook as many dishes as you can before the time runs out.",
                {
                    font: "20px Arial",
                    fill: "red",
                    align: "center"
