...
class OvercookedGridworld(object):
    ...
    @staticmethod
    def from_layout_name(layout_name, folder=None, **params_to_overwrite):
        """
        ...
        base_layout_params = read_layout_dict(layout_name, folder=folder)

        grid = base_layout_params["grid"]
        del base_layout_params["grid"]
        base_layout_params["layout_name"] = layout_name
        # configure the recipes
        Recipe.configure({'all_orders': base_layout_params["start_all_orders"]})
