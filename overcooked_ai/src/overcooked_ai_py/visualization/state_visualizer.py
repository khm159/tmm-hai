...
from overcooked_ai.src.overcooked_ai_py.mdp.layout_generator import (
    COUNTER,
    DISH_DISPENSER,
    EMPTY,
    ONION_DISPENSER,
...
from overcooked_ai.src.overcooked_ai_py.static import FONTS_DIR, GRAPHICS_DIR
from overcooked_ai.src.overcooked_ai_py.utils import (
    classproperty,
    cumulative_rewards_from_rew_list,
    generate_temporary_file_path,
)
from overcooked_ai.src.overcooked_ai_py.visualization.pygame_utils import (
...
class StateVisualizer:
    ...
    DEFAULT_VALUES = {
        ...
        "tile_size": 75,
        "window_fps": 30,
        "player_colors": ["blue", "green", "purple", "red", "black", "yellow"],
